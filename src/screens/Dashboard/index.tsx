    ...
    const data: DataListProps[] = [
        {
            id: '1',
            type: 'positive',
            title: "Desenvo,lvimento de sites",
            amount: "R$ 12.500,00",
            category: {
                name: 'Vendas',
                icon: 'dollar-sign',
    ...
    return (
        <Container>
            <Header>
                <UserWrapper>
                    <UserInfo>
                        <Photo source={{ uri: 'https://avatars.githubusercontent.com/u/55656935?v=4' }} />
                        <User>
            ...
            <HighlightCards >
                ...
                <HighlightCard type="total" title="Total" amount="R$ 16.141,00" lastTransaction="01 de 16 de abril" />
